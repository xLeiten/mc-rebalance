...
import static me.xleiten.rebalance.Settings.MOB_WARDEN__MOVE_SPEED_MULT;
...
public abstract class MixinWardenEntity extends MixinHostileEntity
{
    ...
    public void rebalanceMod$onFirstSpawn(ServerWorldAccess world, Random random, SpawnReason reason) {
        ...
        addModifier(this, EntityAttributes.GENERIC_MOVEMENT_SPEED, modifier("moveSpeedBoost", RandomHelper.range(random, MOB_WARDEN__MOVE_SPEED_MULT.value())));
    }
}
